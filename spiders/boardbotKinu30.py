...
class Boardbotkinu30Spider(scrapy.Spider):
    ...
    def parse(self, response):
        page_no = 1
        last_page_text = response.xpath('//*[@id="cmsContent"]/div[1]/div[1]/span').extract()
    ...
    def parse_post(self, response):
        ...
        body = response.xpath('//*[@id="tab_con"]/div[1]').xpath('string()').get()

        print(title)
        writer = response.xpath('//*[@id="cmsContent"]/div[2]/div[2]/table/tbody/tr[1]/td').xpath('string()').get()
