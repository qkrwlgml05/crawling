...
class UnikoreaSpider(scrapy.Spider):
    name = 'unikorea'
    allowed_domains = ['https://www.unikorea.go.kr']
    start_urls = ['https://www.unikorea.go.kr/books/whitepaper/whitepaper/']

    def __init__(self):
        scrapy.Spider.__init__(self)
        self.start_urls = 'https://www.unikorea.go.kr/books/whitepaper/whitepaper/'
        # 몽고에 넣겠
    ...
    def parse(self, response):
        ...
        while True:
            if page_no > last_page_no:
                break
            link = "https://www.unikorea.go.kr/books/whitepaper/whitepaper/"
    ...
    def parse_each_pages(self, response):
        ...
        while True:
            ...
            url = "https://www.unikorea.go.kr/books/whitepaper/whitepaper/"
