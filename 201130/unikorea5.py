...
class Unikorea5Spider(scrapy.Spider):
    name = 'unikorea5'
    allowed_domains = ['https://www.unikorea.go.kr']
    start_urls = ['https://www.unikorea.go.kr/books/monthly/interchange/']

    def __init__(self):
        scrapy.Spider.__init__(self)
        self.start_urls = 'https://www.unikorea.go.kr/books/monthly/interchange/'
        # 몽고에 넣겠
    ...
    def parse(self, response):
        ...
        while True:
            if page_no > last_page_no:
                break
            link = "https://www.unikorea.go.kr/books/monthly/interchange/?mode=list&boardId=bbs_0000000000000044&searchCondition=all&searchKeyword=&pageIdx=" + str(page_no)
    ...
    def parse_each_pages(self, response):
        ...
        while True:
            ...
            url = response.xpath('//*[@id="main-story"]/div/ul/li[' + str(category_no) + ']/div/a[2]/@href').get()
            url = "https://www.unikorea.go.kr/books/monthly/interchange/" + url
    ...
    def parse_post(self, response):
        ...
        if file_icon:
            file_download_url = response.xpath('//*[@id="bbsForm"]/div/article/div[2]/section/div[2]/ul/li[1]/a[1]/@href').extract()
