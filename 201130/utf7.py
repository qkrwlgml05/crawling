...
class Utf7Spider(scrapy.Spider):
    name = 'utf7'
    allowed_domains = ['https://uft.na.go.kr']
    start_urls = ['https://uft.na.go.kr:444/uft/reference/reference04.do']

    def __init__(self):
        scrapy.Spider.__init__(self)
        self.start_urls = 'https://uft.na.go.kr:444/uft/reference/reference04.do'
        # 몽고에 넣겠다
    ...
    def parse(self, response):
        ...
        while True:
            if page_no > last_page_no:
                break
            link = "https://uft.na.go.kr:444/uft/reference/reference04.do#curPage"
            #print(link)
    ...
    def parse_each_pages(self, response):
        ...
        while True:
            ...
            url = "https://uft.na.go.kr:444/uft/reference/reference04.do" + url
    ...
    def parse_post(self, response):
        ...
        if file_icon:
            ...
            file_download_url = "https://uft.na.go.kr:444/uft/reference/reference04.do" + file_download_url
