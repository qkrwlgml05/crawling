...
class Utf1Spider(scrapy.Spider):
    name = 'utf1'
    allowed_domains = ['https://uft.na.go.kr']
    start_urls = ['https://uft.na.go.kr:444/uft/reference/reference01.do']

    def __init__(self):
        scrapy.Spider.__init__(self)
        self.start_urls = 'https://uft.na.go.kr:444/uft/reference/reference01.do'
        # 몽고에 넣겠다
    ...
    def parse_each_pages(self, response):
        ...
        while True:
            ...
            url = "https://uft.na.go.kr:444/uft/reference/reference01.do" + url
