...
class Unikorea6Spider(scrapy.Spider):
    name = 'unikorea6'
    allowed_domains = ['https://www.unikorea.go.kr']
    start_urls = ['https://www.unikorea.go.kr/books/monthly/report/']

    def __init__(self):
        scrapy.Spider.__init__(self)
        self.start_urls = 'https://www.unikorea.go.kr/books/monthly/report/'
        # 몽고에 넣겠
    ...
    def parse(self, response):
        ...
        while True:
            if page_no > last_page_no:
                break
            link = "https://www.unikorea.go.kr/books/monthly/report/?mode=list&boardId=bbs_0000000000000046&searchCondition=all&searchKeyword=&pageIdx=" + str(page_no)
    ...
    def parse_each_pages(self, response):
        ...
        while True:
            ...
            url = "https://www.unikorea.go.kr/books/monthly/report/" + url
