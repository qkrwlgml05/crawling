...
class Utf2Spider(scrapy.Spider):
    name = 'utf2'
    allowed_domains = ['https://uft.na.go.kr']
    start_urls = ['https://uft.na.go.kr:444/uft/reference/reference02.do']
    ...
    def parse_each_pages(self, response):
        ...
        while True:
            ...
            url = "https://uft.na.go.kr:444/uft/reference/reference02.do" + url
