...
class Utf6Spider(scrapy.Spider):
    name = 'utf6'
    allowed_domains = ['https://uft.na.go.kr']
    start_urls = ['https://uft.na.go.kr:444/uft/reference/reference06.do']

    def __init__(self):
        scrapy.Spider.__init__(self)
        self.start_urls = 'https://uft.na.go.kr:444/uft/reference/reference06.do'
        # 몽고에 넣겠다
    ...
    def parse(self, response):
        ...
        while True:
            if page_no > last_page_no:
                break
            link = "https://uft.na.go.kr:444/uft/reference/reference06.do?mode=list&&articleLimit=10&article.offset=" + str(10*(page_no-1))
            #print(link)
    ...
    def parse_each_pages(self, response):
        ...
        while True:
            ...
            url = "https://uft.na.go.kr:444/uft/reference/reference06.do" + url
    ...
    def parse_post(self, response):
        ...
        if file_icon:
            ...
            file_download_url = "https://uft.na.go.kr:444/uft/reference/reference06.do" + file_download_url
