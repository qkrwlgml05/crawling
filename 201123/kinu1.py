...
class Kinu1Spider(scrapy.Spider):
    name = 'kinu1'
    ...
    def parse(self, response):
        ...
        while True:
            if page_no > last_page_no:
                break
            link = "https://www.kinu.or.kr/brd/board/634/L/menu/371?brdType=L&searchField=&searchText=&thisPage=" + str(page_no)
    ...
    def parse_post(self, response):
        ...
        file_download_url = response.xpath('//*[@id="cmsContent"]/div[2]/div[2]/table/tbody/tr[5]/td/span/a/@href').extract()
        ...
        file_name = title
        file_icon = response.xpath('//*[@id="cmsContent"]/div[2]/div[2]/table/tbody/tr[5]/td/span').get()
