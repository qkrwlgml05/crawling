...
class Peacewomen6Spider(scrapy.Spider):
    name = 'peacewomen6'
    allowed_domains = ['http://www.peacewomen.or.kr/']
    start_urls = ['http://www.peacewomen.or.kr/index.php?mid=wmp_pds_study']

    def __init__(self):
        scrapy.Spider.__init__(self)
        self.start_urls = 'http://www.peacewomen.or.kr/index.php?mid=wmp_pds_study'
        # 몽고에 넣겠다
    ...
    def parse(self, response):
        ...
        while True:
            if page_no > last_page_no:
                break
            link = "http://www.peacewomen.or.kr/index.php?mid=wmp_pds_study&page=" + str(page_no)
    ...
    def parse_each_pages(self, response):
        ...
        last = response.xpath('//*[@id="board_list"]/table/tbody/tr[4]/td[1]/text()').get()
        if page_no == last_page_no:
        ...
        while True:
            ...
            url = "http://www.peacewomen.or.kr/index.php?mid=wmp_pds_study&page=" + url
            print(url)
