...
class Peacewomen2Spider(scrapy.Spider):
    name = 'peacewomen2'
    allowed_domains = ['http://www.peacewomen.or.kr/']
    start_urls = ['http://www.peacewomen.or.kr/index.php?mid=wmp_pds_mil']

    def __init__(self):
        scrapy.Spider.__init__(self)
        self.start_urls = 'http://www.peacewomen.or.kr/index.php?mid=wmp_pds_mil'
        # 몽고에 넣겠다
    ...
    def parse(self, response):
        # 페이지 개수
        total_page_text = response.xpath('//*[@id="s_mid21_wrap0"]/div/div[2]/div[1]/a[3]/@href').extract()
        ...
        while True:
            if page_no > last_page_no:
                break
            link = "http://www.peacewomen.or.kr/index.php?mid=wmp_pds_mil&page=" + str(page_no)
    ...
    def parse_each_pages(self, response):
        ...
        while True:
            ...
            url = "http://www.peacewomen.or.kr/index.php?mid=wmp_pds_mil&page=" + url
