...
class Kinu3Spider(scrapy.Spider):
    name = 'kinu3'
    ...
    def parse(self, response):
        ...
        while True:
            if page_no > last_page_no:
                break
            link = "https://www.kinu.or.kr/www/jsp/prg/api/dlL2.jsp?menuIdx=356&category=128&thisPage=" + str(page_no) + "&searchField="
    ...
    def parse_post(self, response):
        ...
        writer = response.xpath('//*[@id="cmsContent"]/div[2]/table/thead/tr[1]/td/text()').get()
        #print(writer)
