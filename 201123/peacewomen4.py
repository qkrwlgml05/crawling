...
class Peacewomen4Spider(scrapy.Spider):
    name = 'peacewomen4'
    allowed_domains = ['http://www.peacewomen.or.kr/']
    start_urls = ['http://www.peacewomen.or.kr/index.php?mid=wmp_pds_cul']

    def __init__(self):
        scrapy.Spider.__init__(self)
        self.start_urls = 'http://www.peacewomen.or.kr/index.php?mid=wmp_pds_cul'
        # 몽고에 넣겠다
    ...
    def parse(self, response):
        ...
        while True:
            if page_no > last_page_no:
                break
            link = "http://www.peacewomen.or.kr/index.php?mid=wmp_pds_cul&page=" + str(page_no)
    ...
    def parse_each_pages(self, response):
        ...
        if page_no == last_page_no:
            ...
            first = response.xpath('//*[@id="board_list"]/table/tbody/tr[2]/td[1]/text()').get()
