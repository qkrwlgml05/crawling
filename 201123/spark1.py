...
class Spark1Spider(scrapy.Spider):
    name = 'spark1'
    allowed_domains = ['http://www.spark946.org']
    start_urls = ['http://www.spark946.org/data/nuri']

    def __init__(self):
        scrapy.Spider.__init__(self)
        self.start_urls = 'http://www.spark946.org/data/nuri'
        # 몽고에 넣겠다
    ...
    def parse(self, response):
        ...
        while True:
            if page_no > last_page_no:
                break
            link = "http://www.spark946.org/data/nuri?tpf=board/list&board_code=7&page=" + str(page_no)
    ...
    def parse_each_pages(self, response):
        ...
        while True:
            ...
            url = response.xpath('//*[@id="subConts"]/section/section[1]/figure[' + str(category_no) + ']/a/@href').get()
