...
class Kinu43Spider(scrapy.Spider):
    name = 'kinu4-3'
    allowed_domains = ['http://www.kinu.or.kr/']
    start_urls = ['https://www.kinu.or.kr/brd/board/636/L/CATEGORY/690/menu/682?brdCodeField=CATEGORY&brdCodeValue=690']

    def __init__(self):
        scrapy.Spider.__init__(self)
        self.start_urls = 'https://www.kinu.or.kr/brd/board/636/L/CATEGORY/690/menu/682?brdCodeField=CATEGORY&brdCodeValue=690'
        # 몽고에 넣겠
    ...
    def parse(self, response):
        ...
        while True:
            if page_no > last_page_no:
                break
            link = "https://www.kinu.or.kr/brd/board/636/L/CATEGORY/690/menu/682?brdType=L&searchField=&searchText=&thisPage=" + str(page_no)
    ...
    def parse_each_pages(self, response):
        ...
        while True:
            ...
            url = "https://www.kinu.or.kr/brd/board/636/L/CATEGORY/690/menu/682?brdType=L&searchField=&searchText=&thisPage=" + str(page_no)
    ...
    def parse_post(self, response):
        ...
        item['published_institution_url'] = "https://www.kinu.or.kr/brd/board/636/L/CATEGORY/690/menu/682?brdCodeField=CATEGORY&brdCodeValue=690"
