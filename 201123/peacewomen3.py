...
class Peacewomen3Spider(scrapy.Spider):
    name = 'peacewomen3'
    allowed_domains = ['http://www.peacewomen.or.kr/']
    start_urls = ['http://www.peacewomen.or.kr/index.php?mid=wmp_pds_edu']

    def __init__(self):
        scrapy.Spider.__init__(self)
        self.start_urls = 'http://www.peacewomen.or.kr/index.php?mid=wmp_pds_edu'
        # 몽고에 넣겠다
    ...
    def parse(self, response):
        ...
        while True:
            if page_no > last_page_no:
                break
            link = "http://www.peacewomen.or.kr/index.php?mid=wmp_pds_edu&page=" + str(page_no)
