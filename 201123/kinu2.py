...
class Kinu2Spider(scrapy.Spider):
    name = 'kinu2'
    ...
    def parse(self, response):
        # print(response)
        # 페이지 개수
        total_page_text = response.xpath('//*[@id="pageNation_wrap"]/div/a[4]/@onclick').extract()
        total_page_text = ['1']
    ...
    def parse_each_pages(self, response):
        ...
        if page_no == last_page_no:
            ...
            first = response.xpath('//*[@id="boardActionFrm"]/div[2]/table/tbody/tr[8]/td[1]/text()').get()
        ...
        while True:
            ...
            url = response.xpath('//*[@id="boardActionFrm"]/div[2]/table/tbody/tr[' + str(category_no) + ']/td[2]/a/@href').get()
            url = "https://www.kinu.or.kr/www/jsp/prg/api/" + url
    ...
    def parse_post(self, response):
        ...
        item['published_institution_url'] = "http://www.kinu.or.kr/www/jsp/prg/api/dlL2.jsp?menuIdx=354&category=429&thisPage=1&searchField=&searchText="
